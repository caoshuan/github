                       ...
                       <div class="col-md-12">
                            ...
                            <div class="panel-body" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1 "><a href="/home"  class="btn btn-lg btn-info" style="margin-right:0px">return</a></div>
                                </div>
                                ...
                                if(mysqli_num_rows($selectresult)&&(($page<$allpages)||($page==$allpages))) 
                                {
                                    ...
                                    while($rows=mysqli_fetch_assoc($selectresult)) 
                                    {
                                        ...
                                        <input type=hidden  name="to_url"   value="/connectsql/m">
                                        <input type=hidden  name="button_name" value="save">
                                            <button type="submit" class="btn btn-info" name="index1">编辑</button>
                                        </form>

                                        <form action="/connectsql/m" method="POST" style="display: inline;">
                                            <input type=hidden  name="id"   '."value='{$id}'".'>
                                ...
                                <div class="article">
                                <center>
                                <form method="get" action="/index1" style="display: inline;">
                                ...
                                <?php
                                if($page!=$allpages)
                                echo '<form method="get" action="/index1?next=123" style="display: inline;">
