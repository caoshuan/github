        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="/create"><i class="fa fa-qrcode"></i>New articles</a>
                    </li>
                    ...
                    <div class="row">
                       <div class="col-md-12">
                           <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="panel-heading" style="background:url('/source/image3.jpg')">new articles</div>
                            <div class="panel-body" >
                    <form action="/connectsql/m" method="POST">
                        <input type="text" name="title" class="form-control" required="required" placeholder="请输入标题">
                        <br>
                        <textarea name="body" rows="10" class="form-control" required="required" placeholder="请输入内容"></textarea>
                        <br>
                        <button class="btn btn-lg btn-info" name="create">新增文章</button>
                    </form>
